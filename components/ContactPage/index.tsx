      ...
      <div className="flex py-[72px] justify-evenly items-center max-w-screen-lg mx-auto px-4  flex-wrap-reverse ">
        <div className="flex flex-row justify-evenly lg:gap-72 gap-4 flex-wrap">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center py-[42px] gap-10">
              <div>
                <div>
                  Company:{' '}
                  <a className="text-accent">Pinnacle Technology Collective</a>
                </div>
                <div>
                  Address:{' '}
          ...
          <form className="flex-1 max-w-md mx-auto text-white ">
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  name="floating_phone"
                  id="floating_phone"
                  className="block py-4 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  required
                />
                <label
            ...
            <button
              type="submit"
              className="clip-diagonal bg-accent text-sm w-full sm:w-auto px-5 py-2.5 text-center"
            >
              Submit
            </button>
          </form>
